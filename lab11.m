...
maxEncoderDuty = 17; % Set your duty cycle
nb.setMotor(1,maxEncoderDuty);
...
sampleFreq = (abs(val.counts)/runtime); % how many counts did you get over your runtime?
...
while toc < runtime
    ...
    error = 100 - rpm; % Difference between our target and current rpm 
    ...
    nb.setMotor(1, control); % Send the control signal to the motor.
end
